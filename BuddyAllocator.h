...
public:
	...
	bool isFree;	   //usermade, self-explanatory
};
...
public:
	...
	BlockHeader *prev; //created to aid in finding the node for removing
	BlockHeader *temp;
...
public:
	...
	{ // removes a block from the list
		...
		if (prev->next) //if there is a next then it has to be what we're looking for
		{
...
private:
	...
	char *addr; //memory block addressing
